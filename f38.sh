...
echo +600M # Last sector (Accept default: varies)
echo ef00  # Type of partition (EFI system partition)
echo n     # Add a new partition
echo       # Partition number (Accept default: 2)
echo       # Accept first sector
echo +1G   # Have last sector be 1Gig
echo       # Accept default GUID (Linux filesystem)
echo n     # Add a new partition
echo       # Partition number (Accept default: 3)
echo       # First sector (Accept default: varies)
echo +8G   # Have last sector be 8Gig
echo 8200  # Type of partition (swap)
echo n     # Add a new partition
echo       # Partition number (Accept default: 4)
echo       # Accept first sector
echo       # Accept last sector (Default: remaining space)
echo       # Type of parition (Linux Filesystem)
echo c     # Name partition
echo 1     # Partition 1
echo SYS   # Call it 'SYS' for EFI system partition
echo c     # Name partition
echo 2     # Partition 2
echo BOOT  # Call it 'BOOT'
echo c     # Name Partition
echo 3     # Partition 3
echo SWAP  # Call it 'SWAP'
echo c     # Name parition
echo 4     # Partition 4
echo ROOT  # Call it 'ROOT'
echo p     # Print the table
